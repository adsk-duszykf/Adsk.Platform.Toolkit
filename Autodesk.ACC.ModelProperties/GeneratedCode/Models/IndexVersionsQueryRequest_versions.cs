...
namespace Autodesk.ACC.ModelProperties.Models {
    ...
    /// </summary>
    public class IndexVersionsQueryRequest_versions : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="IndexVersionsQueryRequest_versions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static IndexVersionsQueryRequest_versions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IndexVersionsQueryRequest_versions();
        }
        /// <summary>
