...
namespace Autodesk.ACC.ModelProperties.Models {
    ...
    /// </summary>
    public class ManifestDatabaseFilesMappingDef : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ManifestDatabaseFilesMappingDef"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ManifestDatabaseFilesMappingDef CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ManifestDatabaseFilesMappingDef();
        }
        /// <summary>
