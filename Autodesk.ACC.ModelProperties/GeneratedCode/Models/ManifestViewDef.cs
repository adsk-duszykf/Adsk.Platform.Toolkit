...
namespace Autodesk.ACC.ModelProperties.Models {
    ...
    /// manifest views
    /// </summary>
    public class ManifestViewDef : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="ManifestViewDef"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ManifestViewDef CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ManifestViewDef();
        }
        /// <summary>
