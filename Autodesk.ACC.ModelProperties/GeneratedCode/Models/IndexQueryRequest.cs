...
namespace Autodesk.ACC.ModelProperties.Models {
    ...
    /// </summary>
    public class IndexQueryRequest : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="IndexQueryRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static IndexQueryRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new IndexQueryRequest();
        }
        /// <summary>
