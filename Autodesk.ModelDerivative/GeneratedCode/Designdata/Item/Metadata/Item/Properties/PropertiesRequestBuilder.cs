...
namespace Autodesk.ModelDerivative.Designdata.Item.Metadata.Item.Properties {
    ...
    public class PropertiesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <exception cref="AllProperties400Error">When receiving a 400 status code</exception>
        /// <exception cref="AllProperties401Error">When receiving a 401 status code</exception>
        /// <exception cref="AllProperties403Error">When receiving a 403 status code</exception>
        /// <exception cref="AllProperties404Error">When receiving a 404 status code</exception>
        /// <exception cref="AllProperties406Error">When receiving a 406 status code</exception>
        /// <exception cref="AllProperties409Error">When receiving a 409 status code</exception>
        /// <exception cref="AllProperties413Error">When receiving a 413 status code</exception>
        /// <exception cref="AllProperties429Error">When receiving a 429 status code</exception>
        /// <exception cref="AllProperties500Error">When receiving a 500 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<AllProperties?> GetAsync(Action<RequestConfiguration<PropertiesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<AllProperties> GetAsync(Action<RequestConfiguration<PropertiesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                {"400", AllProperties400Error.CreateFromDiscriminatorValue},
                {"401", AllProperties401Error.CreateFromDiscriminatorValue},
                {"403", AllProperties403Error.CreateFromDiscriminatorValue},
                {"404", AllProperties404Error.CreateFromDiscriminatorValue},
                {"406", AllProperties406Error.CreateFromDiscriminatorValue},
                {"409", AllProperties409Error.CreateFromDiscriminatorValue},
                {"413", AllProperties413Error.CreateFromDiscriminatorValue},
                {"429", AllProperties429Error.CreateFromDiscriminatorValue},
                {"500", AllProperties500Error.CreateFromDiscriminatorValue},
            };
            return await RequestAdapter.SendAsync<AllProperties>(requestInfo, AllProperties.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns a list of properties of objects contained in the model view specified by the modelGuid URI parameter. This request returns all properties for all objects by default. However, you can use the objectid query string parameter to return all properties of a specified object.Properties are returned as a flat list ordered, by their objectid. The objectid is a non-persistent ID assigned to an object when a design file is translated to the SVF or SVF2 format. This means that:A design file must be translated to SVF or SVF2 before you can retrieve properties.The objectid of an object can change if the design is translated to SVF or SVF2 again. If you require a persistent ID to reference an object, use `externalId`.**Note**: Before you call this endpoint:Use the `GET {urn}/metadata` endpoint.Obtain the ID of the model view (Viewable) you want to check.Use the ID you obtained as the `modelGuid` URI parameter.**Note**: `POST {urn}/metadata/{modelGuid}/properties:query` provides greater flexibility to retrieve only the properties you are interested in. What’s more the response is paginated. So, when the number of properties returned is large, it can getz you the results faster.
        /// </summary>
