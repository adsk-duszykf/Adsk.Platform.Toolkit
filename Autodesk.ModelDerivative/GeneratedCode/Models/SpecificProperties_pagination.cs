...
namespace Autodesk.ModelDerivative.Models {
    public class SpecificProperties_pagination : IParsable 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="SpecificProperties_pagination"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SpecificProperties_pagination CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SpecificProperties_pagination();
        }
        /// <summary>
