using System.Net;
using Autodesk.ACC.CustomAttributes;
using Autodesk.ACC.CustomAttributes.Projects.Item.VersionsBatchGet;
using Autodesk.Authentication;
using Autodesk.Authentication.Helpers.Models;
using Sdk_Tests;

namespace Tests.ACC.CustomAttributes;

[TestClass]
public class CustomAttributesClientHelperTests
{
    private static readonly Settings config = Settings.Load();
    private CustomAttributesClient CustomAttrClient { get; init; }

    public CustomAttributesClientHelperTests()
    {
    ...
    private CustomAttributesClient InitializeClient()
    {
        ...
        var CustomAttrClient = new CustomAttributesClient(getAccessToken, CCProxyClient);
