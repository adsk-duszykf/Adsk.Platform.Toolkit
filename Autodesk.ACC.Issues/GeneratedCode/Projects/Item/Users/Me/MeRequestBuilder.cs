...
using System;
namespace Autodesk.ACC.Issues.Projects.Item.Users.Me
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Issues.Projects.Item.Users.Me.MeRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MeRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectId}/users/me", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.Issues.Projects.Item.Users.Me.MeRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public MeRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/projects/{projectId}/users/me", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Autodesk.ACC.Issues.Models.UsersMeDefinition?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.ACC.Issues.Models.UsersMeDefinition> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.ACC.Issues.Models.UsersMeDefinition>(requestInfo, global::Autodesk.ACC.Issues.Models.UsersMeDefinition.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns the current user permissions.Note that if a user with *Create for my company* permissions attempts to assign a user from a another company to the issue, it will return an error. Currently, you can only `retrieve users that are associated with an account &lt;https://forge.autodesk.com/en/docs/acc/v1/reference/http/users-GET/&gt;`_. We will be supporting retrieving project users by companies in the near future.You can verify a user&apos;s assignment permissions by checking the ``permittedActions`` or ``permissionLevels`` attributes.This operation is available to everyone... include:: ../../../../_snippets/not-backward-compatible.rst
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.Issues.Projects.Item.Users.Me.MeRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.Issues.Projects.Item.Users.Me.MeRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.Issues.Projects.Item.Users.Me.MeRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
