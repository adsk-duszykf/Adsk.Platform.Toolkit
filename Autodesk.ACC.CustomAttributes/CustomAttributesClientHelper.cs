...
using Autodesk.ACC.CustomAttributes.Projects.Item.Versions.Item.CustomAttributesBatchUpdate;


namespace Autodesk.ACC.CustomAttributes.Helpers;

public class CustomAttributesClientHelper
{
    public BaseCustomAttributesClient Api { get; init; }
    internal CustomAttributesClientHelper(BaseCustomAttributesClient api)
    {
        Api = api;
    }
