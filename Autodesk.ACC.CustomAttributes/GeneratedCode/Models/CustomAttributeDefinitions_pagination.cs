...
namespace Autodesk.ACC.CustomAttributes.Models {
    public class CustomAttributeDefinitions_pagination : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CustomAttributeDefinitions_pagination"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CustomAttributeDefinitions_pagination CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CustomAttributeDefinitions_pagination();
        }
        /// <summary>
