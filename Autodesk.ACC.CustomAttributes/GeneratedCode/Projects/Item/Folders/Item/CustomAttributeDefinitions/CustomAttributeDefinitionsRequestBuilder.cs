...
using System;
namespace Autodesk.ACC.CustomAttributes.Projects.Item.Folders.Item.CustomAttributeDefinitions {
    /// <summary>
    ...
    public class CustomAttributeDefinitionsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="Autodesk.ACC.CustomAttributes.Models.CustomAttributeDefinitions"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Autodesk.ACC.CustomAttributes.Models.CustomAttributeDefinitions?> GetAsync(Action<RequestConfiguration<CustomAttributeDefinitionsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Autodesk.ACC.CustomAttributes.Models.CustomAttributeDefinitions> GetAsync(Action<RequestConfiguration<CustomAttributeDefinitionsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Autodesk.ACC.CustomAttributes.Models.CustomAttributeDefinitions>(requestInfo, Autodesk.ACC.CustomAttributes.Models.CustomAttributeDefinitions.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
