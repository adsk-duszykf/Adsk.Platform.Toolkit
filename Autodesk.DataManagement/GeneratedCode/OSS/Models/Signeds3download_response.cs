...
#nullable restore
        ...
        public static Signeds3download_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return new Signeds3download_response();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"params", n => { Params = n.GetObjectValue<Signeds3download_response_params>(Signeds3download_response_params.CreateFromDiscriminatorValue); } },
                {"sha1", n => { Sha1 = n.GetStringValue(); } },
                {"size", n => { Size = n.GetLongValue(); } },
                {"status", n => { Status = n.GetEnumValue<Signeds3download_response_status>(); } },
                {"url", n => { Url = n.GetStringValue(); } },
                {"urls", n => { Urls = n.GetObjectValue<Signeds3download_response_urls>(Signeds3download_response_urls.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Signeds3download_response_params>("params", Params);
            writer.WriteStringValue("sha1", Sha1);
            writer.WriteLongValue("size", Size);
            writer.WriteEnumValue<Signeds3download_response_status>("status", Status);
            writer.WriteStringValue("url", Url);
            writer.WriteObjectValue<Signeds3download_response_urls>("urls", Urls);
        }
    }
}
