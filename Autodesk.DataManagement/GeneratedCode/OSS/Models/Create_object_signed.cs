...
namespace Autodesk.DataManagement.OSS.Models {
    ...
    /// </summary>
    public class Create_object_signed : IParsable 
    {
...
#nullable restore
        ...
        public static Create_object_signed CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Create_object_signed();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"allowedIpAddresses", n => { AllowedIpAddresses = n.GetCollectionOfPrimitiveValues<string>()?.ToList(); } },
