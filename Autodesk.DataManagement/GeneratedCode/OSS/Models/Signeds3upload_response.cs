...
namespace Autodesk.DataManagement.OSS.Models {
    public class Signeds3upload_response : IParsable 
    {
...
#nullable restore
        ...
        public static Signeds3upload_response CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Signeds3upload_response();
        }
        /// <summary>
