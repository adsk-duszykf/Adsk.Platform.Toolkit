...
namespace Autodesk.DataManagement.OSS.Oss.V2.Buckets.Item.Objects.Item.Signed {
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="SignedRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Create_object_signed"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Create_object_signed?> PostAsync(Create_signed_resource body, Action<RequestConfiguration<SignedRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Create_object_signed> PostAsync(Create_signed_resource body, Action<RequestConfiguration<SignedRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Create_object_signed>(requestInfo, Create_object_signed.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// This endpoint creates a signed URL that can be used to download an object within the specified expiration time. Be aware that if the object the signed URL points to is deleted or expires before the signed URL expires, then the signed URL will no longer be valid. A successful call to this endpoint requires bucket owner access.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Create_signed_resource body, Action<RequestConfiguration<SignedRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Create_signed_resource body, Action<RequestConfiguration<SignedRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="SignedRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SignedRequestBuilder WithUrl(string rawUrl)
        {
            return new SignedRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// This endpoint creates a signed URL that can be used to download an object within the specified expiration time. Be aware that if the object the signed URL points to is deleted or expires before the signed URL expires, then the signed URL will no longer be valid. A successful call to this endpoint requires bucket owner access.
        /// </summary>
        public class SignedRequestBuilderPostQueryParameters 
        {
...
#nullable restore
        ...
        public class SignedRequestBuilderPostRequestConfiguration : RequestConfiguration<SignedRequestBuilderPostQueryParameters> 
        {
        }
    }
}
