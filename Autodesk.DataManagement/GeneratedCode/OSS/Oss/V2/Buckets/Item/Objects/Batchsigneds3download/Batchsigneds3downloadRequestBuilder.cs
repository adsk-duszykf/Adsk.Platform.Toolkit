...
namespace Autodesk.DataManagement.OSS.Oss.V2.Buckets.Item.Objects.Batchsigneds3download {
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Batchsigneds3downloadRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Batchsigneds3download_response"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Batchsigneds3download_response?> PostAsync(Batchsigneds3download_object body, Action<RequestConfiguration<Batchsigneds3downloadRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Batchsigneds3download_response> PostAsync(Batchsigneds3download_object body, Action<RequestConfiguration<Batchsigneds3downloadRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Batchsigneds3download_response>(requestInfo, Batchsigneds3download_response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets one or more signed URLs to download objects. The signed URLs can be used to download the objects directly from S3, skipping OSS servers. Be aware that expiration time for the signed URL(s) is just 60 seconds. So, a request to the URL(s) must begin within 60 seconds; the transfer of the data can exceed 60 seconds. A successful call to this endpoint requires bucket owner access.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(Batchsigneds3download_object body, Action<RequestConfiguration<Batchsigneds3downloadRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(Batchsigneds3download_object body, Action<RequestConfiguration<Batchsigneds3downloadRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Batchsigneds3downloadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Batchsigneds3downloadRequestBuilder WithUrl(string rawUrl)
        {
            return new Batchsigneds3downloadRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets one or more signed URLs to download objects. The signed URLs can be used to download the objects directly from S3, skipping OSS servers. Be aware that expiration time for the signed URL(s) is just 60 seconds. So, a request to the URL(s) must begin within 60 seconds; the transfer of the data can exceed 60 seconds. A successful call to this endpoint requires bucket owner access.
        /// </summary>
        public class Batchsigneds3downloadRequestBuilderPostQueryParameters 
        {
        ...
        public class Batchsigneds3downloadRequestBuilderPostRequestConfiguration : RequestConfiguration<Batchsigneds3downloadRequestBuilderPostQueryParameters> 
        {
        }
    }
}
