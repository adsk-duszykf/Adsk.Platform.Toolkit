...
namespace Autodesk.DataManagement.OSS.Oss.V2.Buckets.Item.Objects.Item.Signeds3download {
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="Signeds3downloadRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="Signeds3download_response"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Signeds3download_response?> GetAsync(Action<RequestConfiguration<Signeds3downloadRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Signeds3download_response> GetAsync(Action<RequestConfiguration<Signeds3downloadRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<Signeds3download_response>(requestInfo, Signeds3download_response.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets a signed URL to a download an object directly from S3, bypassing OSS servers. This signed URL expires in 60 seconds, so the request must begin within that time frame; the actual data transfer can take longer. Note that resumable uploads store each chunk individually; after the upload completes, an async process merges all the chunks and creates the definitive OSS file. If you request a signed URL before the async process completes, the response returns a map of S3 URLs, one per chunk; the key is the byte range of the total file to which the chunk corresponds. If you need a single URL in the response, you can use OSS signed resource functionality by setting the &apos;public-resource-fallback&apos; query parameter to true. Lastly, note that ranged downloads can be used with the returned URL.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Signeds3downloadRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<Signeds3downloadRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="Signeds3downloadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public Signeds3downloadRequestBuilder WithUrl(string rawUrl)
        {
            return new Signeds3downloadRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets a signed URL to a download an object directly from S3, bypassing OSS servers. This signed URL expires in 60 seconds, so the request must begin within that time frame; the actual data transfer can take longer. Note that resumable uploads store each chunk individually; after the upload completes, an async process merges all the chunks and creates the definitive OSS file. If you request a signed URL before the async process completes, the response returns a map of S3 URLs, one per chunk; the key is the byte range of the total file to which the chunk corresponds. If you need a single URL in the response, you can use OSS signed resource functionality by setting the &apos;public-resource-fallback&apos; query parameter to true. Lastly, note that ranged downloads can be used with the returned URL.
        /// </summary>
        public class Signeds3downloadRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class Signeds3downloadRequestBuilderGetRequestConfiguration : RequestConfiguration<Signeds3downloadRequestBuilderGetQueryParameters> 
        {
        }
    }
}
