...
namespace Autodesk.DataManagement.Models {
    public class Search_data_attributes_extension_data : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Search_data_attributes_extension_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Search_data_attributes_extension_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Search_data_attributes_extension_data();
        }
        /// <summary>
