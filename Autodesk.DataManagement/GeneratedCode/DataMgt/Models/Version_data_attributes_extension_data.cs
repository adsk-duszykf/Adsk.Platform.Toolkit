...
namespace Autodesk.DataManagement.Models {
    public class Version_data_attributes_extension_data : IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Version_data_attributes_extension_data_properties? Properties { get; set; }
#nullable restore
#else
        public Version_data_attributes_extension_data_properties Properties { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Version_data_attributes_extension_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Version_data_attributes_extension_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Version_data_attributes_extension_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"properties", n => { Properties = n.GetObjectValue<Version_data_attributes_extension_data_properties>(Version_data_attributes_extension_data_properties.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Version_data_attributes_extension_data_properties>("properties", Properties);
