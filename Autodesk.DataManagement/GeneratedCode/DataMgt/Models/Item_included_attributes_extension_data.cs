...
namespace Autodesk.DataManagement.Models {
    public class Item_included_attributes_extension_data : IParsable 
    {
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Item_included_attributes_extension_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Item_included_attributes_extension_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Item_included_attributes_extension_data();
        }
        /// <summary>
