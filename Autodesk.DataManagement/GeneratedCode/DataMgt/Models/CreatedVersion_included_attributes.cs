...
namespace Autodesk.DataManagement.Models {
    public class CreatedVersion_included_attributes : IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public CreatedVersion_included_attributes_extension? Extension { get; set; }
#nullable restore
#else
        public CreatedVersion_included_attributes_extension Extension { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="CreatedVersion_included_attributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CreatedVersion_included_attributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CreatedVersion_included_attributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"extension", n => { Extension = n.GetObjectValue<CreatedVersion_included_attributes_extension>(CreatedVersion_included_attributes_extension.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<CreatedVersion_included_attributes_extension>("extension", Extension);
