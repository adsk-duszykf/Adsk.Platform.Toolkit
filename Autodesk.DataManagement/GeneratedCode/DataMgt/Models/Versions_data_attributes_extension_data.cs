...
namespace Autodesk.DataManagement.Models {
    public class Versions_data_attributes_extension_data : IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Versions_data_attributes_extension_data_properties? Properties { get; set; }
#nullable restore
#else
        public Versions_data_attributes_extension_data_properties Properties { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Versions_data_attributes_extension_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Versions_data_attributes_extension_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Versions_data_attributes_extension_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"properties", n => { Properties = n.GetObjectValue<Versions_data_attributes_extension_data_properties>(Versions_data_attributes_extension_data_properties.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Versions_data_attributes_extension_data_properties>("properties", Properties);
