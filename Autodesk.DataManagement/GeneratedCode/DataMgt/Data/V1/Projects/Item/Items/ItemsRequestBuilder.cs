...
namespace Autodesk.DataManagement.Data.V1.Projects.Item.Items {
    ...
    public class ItemsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public WithItem_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("item_id", position);
                return new WithItem_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        ...
        /// <exception cref="Item409Error">When receiving a 409 status code</exception>
        /// <exception cref="Item423Error">When receiving a 423 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<Autodesk.DataManagement.Models.Item?> PostAsync(CreateItem body, Action<RequestConfiguration<ItemsRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<Autodesk.DataManagement.Models.Item> PostAsync(CreateItem body, Action<RequestConfiguration<ItemsRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                {"409", Item409Error.CreateFromDiscriminatorValue},
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(CreateItem body, Action<RequestConfiguration<ItemsRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(CreateItem body, Action<RequestConfiguration<ItemsRequestBuilderPostQueryParameters>> requestConfiguration = default)
