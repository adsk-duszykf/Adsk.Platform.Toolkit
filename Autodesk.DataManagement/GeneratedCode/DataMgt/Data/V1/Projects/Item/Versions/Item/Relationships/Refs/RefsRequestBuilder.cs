...
namespace Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder.RefsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder.RefsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns the custom relationships that are associated with the given version_id. Custom relationships can be established between a version of an item and other resources within the data domain service (folders, items, and versions).Notes:Each relationship is defined by the id of the object at the other end of the relationship, together with type, specific reference meta including extension data.Callers will typically use a filter parameter to restrict the response to the custom relationship types (filter[meta.refType]) they are interested in.The response body will have an included array which contains the resources that are involved in the relationship, which is essentially the GET projects/:project_id/versions/:version_id/refs endpoint.To get custom relationships for multiple versions, see the ListRefs command.New! Autodesk Construction Cloud platform (ACC). Note that this endpoint is compatible with ACC projects. For more information about the Autodesk Construction Cloud APIs, see the Autodesk Construction Cloud documentation.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Filter by the direction of the reference. Possible values: from, to</summary>
            [QueryParameter("filter%5Bdirection%5D")]
            public global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.GetFilterDirectionQueryParameterType? FilterdirectionAsGetFilterDirectionQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filter by refType. Possible values: derived, dependencies, auxiliary, xrefs, includes</summary>
            [QueryParameter("filter%5BrefType%5D")]
            public global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.GetFilterRefTypeQueryParameterType? FilterrefTypeAsGetFilterRefTypeQueryParameterType { get; set; }
...
#nullable enable
            [QueryParameter("filter%5Btype%5D")]
            public global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.GetFilterTypeQueryParameterType[]? FiltertypeAsGetFilterTypeQueryParameterType { get; set; }
#nullable restore
#else
            [QueryParameter("filter%5Btype%5D")]
            public global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.GetFilterTypeQueryParameterType[] FiltertypeAsGetFilterTypeQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.16.0")]
        public partial class RefsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Autodesk.DataManagement.Data.V1.Projects.Item.Versions.Item.Relationships.Refs.RefsRequestBuilder.RefsRequestBuilderGetQueryParameters>
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
