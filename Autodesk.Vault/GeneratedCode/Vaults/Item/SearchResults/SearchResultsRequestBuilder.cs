...
using System;
namespace Autodesk.Vault.Vaults.Item.SearchResults
{
    /// <summary>
    /// Builds and executes requests for operations under \vaults\{-id}\search-results
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class SearchResultsRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchResultsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vaults/{%2Did}/search-results{?cursorState*,limit*,option%5BextendedModels%5D*,option%5BlatestOnly%5D*,option%5BpropDefIds%5D*,option%5BreleasedFilesOnly%5D*,option%5BreleasedItemsOnly%5D*,option%5BsearchContent%5D*,option%5BsearchSubFolders%5D*,q*,sort*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SearchResultsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/vaults/{%2Did}/search-results{?cursorState*,limit*,option%5BextendedModels%5D*,option%5BlatestOnly%5D*,option%5BpropDefIds%5D*,option%5BreleasedFilesOnly%5D*,option%5BreleasedItemsOnly%5D*,option%5BsearchContent%5D*,option%5BsearchSubFolders%5D*,q*,sort*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<global::Autodesk.Vault.Models.EntityCollection?> GetAsync(Action<RequestConfiguration<global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.Vault.Models.EntityCollection> GetAsync(Action<RequestConfiguration<global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Basic Search: Find entities using a query string. The text is searched across all properties or both properties and content based on options passed.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SearchResultsRequestBuilderGetQueryParameters 
        {
...
#nullable restore
            ...
            /// <summary>``true``: Search full content of the file.``false``: (Default) Search only properties of the file.</summary>
            [QueryParameter("option%5BsearchContent%5D")]
            public bool? OptionsearchContent { get; set; }
            /// <summary>``true``: Search sub folders.``false``: (Default) Do not search sub folders.</summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class SearchResultsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::Autodesk.Vault.Vaults.Item.SearchResults.SearchResultsRequestBuilder.SearchResultsRequestBuilderGetQueryParameters>
        {
        }
    }
}
