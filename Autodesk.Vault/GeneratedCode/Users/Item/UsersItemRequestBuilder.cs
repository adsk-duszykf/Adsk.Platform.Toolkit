...
using Autodesk.Vault.Users.Item.Accounts;
...
using System;
namespace Autodesk.Vault.Users.Item
{
    /// <summary>
    ...
    public partial class UsersItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Autodesk.Vault.Users.Item.Accounts.AccountsRequestBuilder Accounts
        {
            get => new global::Autodesk.Vault.Users.Item.Accounts.AccountsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.Vault.Users.Item.UsersItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::Autodesk.Vault.Models.UserExtended?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.Vault.Models.UserExtended> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.Vault.Models.UserExtended>(requestInfo, global::Autodesk.Vault.Models.UserExtended.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Get full user object associated with the specified userId.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.Vault.Users.Item.UsersItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.Vault.Users.Item.UsersItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
