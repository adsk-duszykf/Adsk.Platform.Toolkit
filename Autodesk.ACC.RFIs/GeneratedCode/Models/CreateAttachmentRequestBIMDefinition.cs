...
namespace Autodesk.ACC.RFIs.Models {
    public class CreateAttachmentRequestBIMDefinition : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="CreateAttachmentRequestBIMDefinition"/> and sets the default values.
        /// </summary>
        public CreateAttachmentRequestBIMDefinition()
        {
            AdditionalData = new Dictionary<string, object>();
            UrnType = CreateAttachmentRequestBIMDefinition_urnType.Oss;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="CreateAttachmentRequestBIMDefinition"/></returns>
        ...
        public static CreateAttachmentRequestBIMDefinition CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ...
            return new CreateAttachmentRequestBIMDefinition();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"urnType", n => { UrnType = n.GetEnumValue<CreateAttachmentRequestBIMDefinition_urnType>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<CreateAttachmentRequestBIMDefinition_urnType>("urnType", UrnType);
