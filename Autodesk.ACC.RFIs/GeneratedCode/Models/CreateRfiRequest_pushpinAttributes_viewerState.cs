...
namespace Autodesk.ACC.RFIs.Models {
    ...
    public class CreateRfiRequest_pushpinAttributes_viewerState : IAdditionalDataHolder, IParsable 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="CreateRfiRequest_pushpinAttributes_viewerState"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CreateRfiRequest_pushpinAttributes_viewerState CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CreateRfiRequest_pushpinAttributes_viewerState();
        }
        /// <summary>
