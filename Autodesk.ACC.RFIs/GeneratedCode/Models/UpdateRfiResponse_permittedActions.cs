...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UpdateRfiResponse_permittedActions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UpdateRfiResponse_permittedActions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpdateRfiResponse_permittedActions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"updateRfi", n => { UpdateRfi = n.GetObjectValue<UpdateRfiResponse_permittedActions_updateRfi>(UpdateRfiResponse_permittedActions_updateRfi.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
