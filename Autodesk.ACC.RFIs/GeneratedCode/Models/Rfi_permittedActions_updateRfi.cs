...
#nullable enable
        public Rfi_permittedActions_updateRfi_allPermittedStatuses? AllPermittedStatuses { get; set; }
#nullable restore
#else
        public Rfi_permittedActions_updateRfi_allPermittedStatuses AllPermittedStatuses { get; set; }
#endif
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="Rfi_permittedActions_updateRfi"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static Rfi_permittedActions_updateRfi CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new Rfi_permittedActions_updateRfi();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"allPermittedStatuses", n => { AllPermittedStatuses = n.GetObjectValue<Rfi_permittedActions_updateRfi_allPermittedStatuses>(Rfi_permittedActions_updateRfi_allPermittedStatuses.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<Rfi_permittedActions_updateRfi_allPermittedStatuses>("allPermittedStatuses", AllPermittedStatuses);
