...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="UsersMeResponse_permittedActions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UsersMeResponse_permittedActions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UsersMeResponse_permittedActions();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"createRfi", n => { CreateRfi = n.GetObjectValue<UsersMeResponse_permittedActions_createRfi>(UsersMeResponse_permittedActions_createRfi.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
