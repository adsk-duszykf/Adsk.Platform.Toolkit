...
#nullable enable
        public UpdateRfiRequest_pushpinAttributes_location? Location { get; set; }
#nullable restore
#else
        public UpdateRfiRequest_pushpinAttributes_location Location { get; set; }
#endif
        ...
        /// </summary>
        /// <returns>A <see cref="UpdateRfiRequest_pushpinAttributes"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static UpdateRfiRequest_pushpinAttributes CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new UpdateRfiRequest_pushpinAttributes();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"location", n => { Location = n.GetObjectValue<UpdateRfiRequest_pushpinAttributes_location>(UpdateRfiRequest_pushpinAttributes_location.CreateFromDiscriminatorValue); } },
                {"type", n => { Type = n.GetEnumValue<UpdateRfiRequest_pushpinAttributes_type>(); } },
            };
        }
        /// <summary>
