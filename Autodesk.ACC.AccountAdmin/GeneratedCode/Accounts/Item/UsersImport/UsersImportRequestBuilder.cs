...
namespace Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport
{
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostResponse"/></returns>
...
#nullable enable
        public async Task<global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostResponse?> PostAsUsersImportPostResponseAsync(global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostResponse> PostAsUsersImportPostResponseAsync(global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostResponse>(requestInfo, global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Private Use - Add multiple users to the account at once.  Can add up to 200 users per request.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportResponse?> PostAsync(global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportResponse> PostAsync(global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportResponse>(requestInfo, global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Private Use - Add multiple users to the account at once.  Can add up to 200 users per request.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.AccountAdmin.Accounts.Item.UsersImport.UsersImportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
