...
namespace Autodesk.ACC.AccountAdmin.Accounts.Item.Projects {
    public class ProjectsPostResponse : Project, IParsable {
        ...
        public static new ProjectsPostResponse CreateFromDiscriminatorValue(IParseNode parseNode) {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ProjectsPostResponse();
        }
        /// <summary>
