...
namespace Autodesk.ACC.AccountAdmin.Accounts.Item.Projects {
    ...
    public class ProjectsRequestBuilder : BaseRequestBuilder {
        ...
        public ProjectsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{accountId}/projects{?filter%5BjobNumber%5D*,filter%5Bplatform%5D*,filter%5Bproducts%5D*,filterTextMatch*,limit*,offset*,fields*,filter%5Bname%5D*,filter%5Btype%5D*,filter%5Bstatus%5D*,filter%5BserviceName%5D*,filter%5BserviceNames%5D*,filter%5BbusinessUnitId%5D*,filter%5BdataServiceId%5D*,filter%5Bsource%5D*,filter%5BupdatedAt%5D*,sort*}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new ProjectsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ProjectsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/accounts/{accountId}/projects{?filter%5BjobNumber%5D*,filter%5Bplatform%5D*,filter%5Bproducts%5D*,filterTextMatch*,limit*,offset*,fields*,filter%5Bname%5D*,filter%5Btype%5D*,filter%5Bstatus%5D*,filter%5BserviceName%5D*,filter%5BserviceNames%5D*,filter%5BbusinessUnitId%5D*,filter%5BdataServiceId%5D*,filter%5Bsource%5D*,filter%5BupdatedAt%5D*,sort*}", rawUrl) {
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProjectsPostResponse?> PostAsProjectsPostResponseAsync(ProjectsPostRequestBody body, Action<ProjectsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ProjectsPostResponse> PostAsProjectsPostResponseAsync(ProjectsPostRequestBody body, Action<ProjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
            ...
            return await RequestAdapter.SendAsync<ProjectsPostResponse>(requestInfo, ProjectsPostResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Private Use - Create a project in an account.  When creating the project either a list of services to activate or a template can be provided but not both.  The adding of services is an asynchronous job and so a jobId will be included in the response.  The GET jobs/{jobId} endpoint can be used to check the status of the job.
        /// </summary>
        ...
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        [Obsolete("This method is obsolete. Use PostAsProjectsPostResponse instead.")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<ProjectsResponse?> PostAsync(ProjectsPostRequestBody body, Action<ProjectsRequestBuilderPostRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<ProjectsResponse> PostAsync(ProjectsPostRequestBody body, Action<ProjectsRequestBuilderPostRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
