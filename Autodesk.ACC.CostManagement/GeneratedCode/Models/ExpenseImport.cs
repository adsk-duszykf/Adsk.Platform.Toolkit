...
namespace Autodesk.ACC.CostManagement.Models
{
    ...
    public partial class ExpenseImport : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::Autodesk.ACC.CostManagement.Models.ExpenseImport_aggregateBy? AggregateBy { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::Autodesk.ACC.CostManagement.Models.ExpenseItem>? ExpenseItems { get; set; }
#nullable restore
#else
        public List<global::Autodesk.ACC.CostManagement.Models.ExpenseItem> ExpenseItems { get; set; }
#endif
...
#nullable restore
        ...
        public global::Autodesk.ACC.CostManagement.Models.ExpenseImport_integrationState? IntegrationState { get; set; }
...
#nullable restore
        ...
        public global::Autodesk.ACC.CostManagement.Models.ExpenseImport_scope? Scope { get; set; }
        /// <summary>The status of the expense. Possible values: ``draft``, ``pending``, ``revise``, ``rejected``, ``approved``, ``paid``.</summary>
        public global::Autodesk.ACC.CostManagement.Models.ExpenseImport_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.CostManagement.Models.ExpenseImport"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.CostManagement.Models.ExpenseImport"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.ACC.CostManagement.Models.ExpenseImport CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.CostManagement.Models.ExpenseImport();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "aggregateBy", n => { AggregateBy = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_aggregateBy>(); } },
                { "approvedAt", n => { ApprovedAt = n.GetDateTimeOffsetValue(); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "expenseItems", n => { ExpenseItems = n.GetCollectionOfObjectValues<global::Autodesk.ACC.CostManagement.Models.ExpenseItem>(global::Autodesk.ACC.CostManagement.Models.ExpenseItem.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "integrationState", n => { IntegrationState = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_integrationState>(); } },
                ...
                { "scope", n => { Scope = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_scope>(); } },
                { "status", n => { Status = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_aggregateBy>("aggregateBy", AggregateBy);
            writer.WriteStringValue("description", Description);
            writer.WriteCollectionOfObjectValues<global::Autodesk.ACC.CostManagement.Models.ExpenseItem>("expenseItems", ExpenseItems);
            writer.WriteStringValue("externalId", ExternalId);
            writer.WriteStringValue("externalMessage", ExternalMessage);
            writer.WriteStringValue("externalSystem", ExternalSystem);
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_integrationState>("integrationState", IntegrationState);
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_scope>("scope", Scope);
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseImport_status>("status", Status);
