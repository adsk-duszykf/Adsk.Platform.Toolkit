...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="FormInstance"/> and sets the default values.
        /// </summary>
        public FormInstance()
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"costItems", n => { CostItems = n.GetCollectionOfObjectValues<FormInstance_costItems>(FormInstance_costItems.CreateFromDiscriminatorValue)?.ToList(); } },
                ...
                {"integrationState", n => { IntegrationState = n.GetEnumValue<FormInstance_integrationState>(); } },
                ...
                {"properties", n => { Properties = n.GetCollectionOfObjectValues<PropertyResponse>(PropertyResponse.CreateFromDiscriminatorValue)?.ToList(); } },
                {"proposed", n => { Proposed = n.GetStringValue(); } },
                {"scope", n => { Scope = n.GetEnumValue<FormInstance_scope>(); } },
                {"scopeOfWork", n => { ScopeOfWork = n.GetStringValue(); } },
                {"sourceId", n => { SourceId = n.GetStringValue(); } },
                {"submitted", n => { Submitted = n.GetStringValue(); } },
                {"type", n => { Type = n.GetStringValue(); } },
                {"updatedAt", n => { UpdatedAt = n.GetDateTimeOffsetValue(); } },
                {"variableMarkupFormulaItems", n => { VariableMarkupFormulaItems = n.GetCollectionOfObjectValues<FormInstance_variableMarkupFormulaItems>(FormInstance_variableMarkupFormulaItems.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<FormInstance_costItems>("costItems", CostItems);
            ...
            writer.WriteEnumValue<FormInstance_integrationState>("integrationState", IntegrationState);
            ...
            writer.WriteCollectionOfObjectValues<PropertyResponse>("properties", Properties);
            writer.WriteEnumValue<FormInstance_scope>("scope", Scope);
            writer.WriteStringValue("scopeOfWork", ScopeOfWork);
            writer.WriteStringValue("type", Type);
            writer.WriteCollectionOfObjectValues<FormInstance_variableMarkupFormulaItems>("variableMarkupFormulaItems", VariableMarkupFormulaItems);
