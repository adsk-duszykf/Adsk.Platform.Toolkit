...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="FormInstanceUpdate"/> and sets the default values.
        /// </summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"integrationState", n => { IntegrationState = n.GetEnumValue<FormInstanceUpdate_integrationState>(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"note", n => { Note = n.GetStringValue(); } },
                {"ownerId", n => { OwnerId = n.GetStringValue(); } },
                {"scope", n => { Scope = n.GetEnumValue<FormInstanceUpdate_scope>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<FormInstanceUpdate_integrationState>("integrationState", IntegrationState);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("note", Note);
            writer.WriteStringValue("ownerId", OwnerId);
            writer.WriteEnumValue<FormInstanceUpdate_scope>("scope", Scope);
