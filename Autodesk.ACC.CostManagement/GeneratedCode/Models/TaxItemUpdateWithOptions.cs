...
namespace Autodesk.ACC.CostManagement.Models {
    public class TaxItemUpdateWithOptions : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="TaxItemUpdateWithOptions"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="TaxItemUpdateWithOptions"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static TaxItemUpdateWithOptions CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new TaxItemUpdateWithOptions();
        }
        /// <summary>
