...
namespace Autodesk.ACC.CostManagement.Models {
    public class SOVSync_current_data : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="SOVSync_current_data"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="SOVSync_current_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static SOVSync_current_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new SOVSync_current_data();
        }
        /// <summary>
