...
namespace Autodesk.ACC.CostManagement.Models
{
    ...
    public partial class SOVUpdate : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string ExchangeRate { get; set; }
#endif
        /// <summary>The locked schedule of value item field. You can lock one of the item&apos;s amount (``amount``), quantity (``quantity``), or unit cost (``unitPrice``) when calculating a schedule of value.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.CostManagement.Models.SOVUpdate"/> and sets the default values.
        /// </summary>
        public SOVUpdate()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.CostManagement.Models.SOVUpdate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.ACC.CostManagement.Models.SOVUpdate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.CostManagement.Models.SOVUpdate();
        }
        /// <summary>
