...
namespace Autodesk.ACC.CostManagement.Models {
    public class DocumentPackageCreate : IAdditionalDataHolder, IParsable 
    {
        ...
        public DocumentPackageCreate_associationType? AssociationType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="DocumentPackageCreate"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="DocumentPackageCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static DocumentPackageCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DocumentPackageCreate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"associationType", n => { AssociationType = n.GetEnumValue<DocumentPackageCreate_associationType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<DocumentPackageCreate_associationType>("associationType", AssociationType);
