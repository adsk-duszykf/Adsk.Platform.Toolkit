...
namespace Autodesk.ACC.CostManagement.Models
{
    ...
    public partial class SubCostItemUpdate : IAdditionalDataHolder, IParsable
...
#nullable restore
        ...
        public string InputQuantity { get; set; }
#endif
        /// <summary>The locked sub cost item field. You can lock the item&apos;s amount (``amount``), quantity (``quantity``), or unit cost (``unitPrice``) when calculating it.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate"/> and sets the default values.
        /// </summary>
        public SubCostItemUpdate()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "type", n => { Type = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.SubCostItemUpdate_type>("type", Type);
