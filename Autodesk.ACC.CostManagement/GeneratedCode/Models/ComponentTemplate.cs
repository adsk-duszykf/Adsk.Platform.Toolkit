...
namespace Autodesk.ACC.CostManagement.Models {
    public class ComponentTemplate : IAdditionalDataHolder, IParsable 
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; }
        /// <summary>The entity type of the duplicable entity result.</summary>
        public ComponentTemplate_assetType? AssetType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="ComponentTemplate"/> and sets the default values.
        /// </summary>
        ...
        public static ComponentTemplate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                {"assetType", n => { AssetType = n.GetEnumValue<ComponentTemplate_assetType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<ComponentTemplate_assetType>("assetType", AssetType);
