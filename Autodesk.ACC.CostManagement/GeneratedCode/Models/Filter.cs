...
#nullable restore
        ...
        public Filter_scope? Scope { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public Filter_viewState? ViewState { get; set; }
#nullable restore
#else
        public Filter_viewState ViewState { get; set; }
#endif
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"scope", n => { Scope = n.GetEnumValue<Filter_scope>(); } },
                {"type", n => { Type = n.GetEnumValue<Filter_type>(); } },
                {"updatedAt", n => { UpdatedAt = n.GetDateTimeOffsetValue(); } },
                {"viewState", n => { ViewState = n.GetObjectValue<Filter_viewState>(Filter_viewState.CreateFromDiscriminatorValue); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Filter_scope>("scope", Scope);
            writer.WriteEnumValue<Filter_type>("type", Type);
            writer.WriteObjectValue<Filter_viewState>("viewState", ViewState);
