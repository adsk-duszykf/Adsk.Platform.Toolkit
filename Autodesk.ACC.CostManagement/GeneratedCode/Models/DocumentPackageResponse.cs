...
namespace Autodesk.ACC.CostManagement.Models {
    public class DocumentPackageResponse : IAdditionalDataHolder, IParsable 
    {
        ...
        public DocumentPackageResponse_associationType? AssociationType { get; set; }
...
#nullable enable
        public DocumentPackageResponse_errorInfo? ErrorInfo { get; set; }
#nullable restore
#else
        public DocumentPackageResponse_errorInfo ErrorInfo { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DocumentPackageItem>? Items { get; set; }
#nullable restore
#else
        public List<DocumentPackageItem> Items { get; set; }
#endif
...
#nullable restore
        ...
        public DocumentPackageResponse_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="DocumentPackageResponse"/> and sets the default values.
        /// </summary>
        ...
        public static DocumentPackageResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DocumentPackageResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"associationType", n => { AssociationType = n.GetEnumValue<DocumentPackageResponse_associationType>(); } },
                {"createdAt", n => { CreatedAt = n.GetDateTimeOffsetValue(); } },
                {"errorInfo", n => { ErrorInfo = n.GetObjectValue<DocumentPackageResponse_errorInfo>(DocumentPackageResponse_errorInfo.CreateFromDiscriminatorValue); } },
                {"id", n => { Id = n.GetGuidValue(); } },
                {"items", n => { Items = n.GetCollectionOfObjectValues<DocumentPackageItem>(DocumentPackageItem.CreateFromDiscriminatorValue)?.ToList(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"recipientId", n => { RecipientId = n.GetStringValue(); } },
                {"status", n => { Status = n.GetEnumValue<DocumentPackageResponse_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<DocumentPackageResponse_associationType>("associationType", AssociationType);
            writer.WriteObjectValue<DocumentPackageResponse_errorInfo>("errorInfo", ErrorInfo);
            writer.WriteCollectionOfObjectValues<DocumentPackageItem>("items", Items);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("recipientId", RecipientId);
            writer.WriteEnumValue<DocumentPackageResponse_status>("status", Status);
