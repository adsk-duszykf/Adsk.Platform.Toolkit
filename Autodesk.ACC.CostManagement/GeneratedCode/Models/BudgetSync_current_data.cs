...
namespace Autodesk.ACC.CostManagement.Models {
    public class BudgetSync_current_data : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public BudgetSync_current_data_budgetCode? BudgetCode { get; set; }
#nullable restore
#else
        public BudgetSync_current_data_budgetCode BudgetCode { get; set; }
#endif
...
#nullable restore
        ...
        public BudgetSync_current_data_integrationState? IntegrationState { get; set; }
...
#nullable restore
        ...
        public BudgetSync_current_data_scope? Scope { get; set; }
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="BudgetSync_current_data"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="BudgetSync_current_data"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static BudgetSync_current_data CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new BudgetSync_current_data();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"budgetCode", n => { BudgetCode = n.GetObjectValue<BudgetSync_current_data_budgetCode>(BudgetSync_current_data_budgetCode.CreateFromDiscriminatorValue); } },
                ...
                {"integrationState", n => { IntegrationState = n.GetEnumValue<BudgetSync_current_data_integrationState>(); } },
                ...
                {"scope", n => { Scope = n.GetEnumValue<BudgetSync_current_data_scope>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<BudgetSync_current_data_budgetCode>("budgetCode", BudgetCode);
            ...
            writer.WriteEnumValue<BudgetSync_current_data_integrationState>("integrationState", IntegrationState);
            ...
            writer.WriteEnumValue<BudgetSync_current_data_scope>("scope", Scope);
