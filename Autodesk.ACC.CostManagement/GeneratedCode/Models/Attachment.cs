...
namespace Autodesk.ACC.CostManagement.Models {
    public class Attachment : IAdditionalDataHolder, IParsable 
    {
        ...
        public Attachment_associationType? AssociationType { get; set; }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"associationType", n => { AssociationType = n.GetEnumValue<Attachment_associationType>(); } },
                {"createdAt", n => { CreatedAt = n.GetDateTimeOffsetValue(); } },
                {"folderId", n => { FolderId = n.GetGuidValue(); } },
                {"id", n => { Id = n.GetGuidValue(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"replaceIfExists", n => { ReplaceIfExists = n.GetBoolValue(); } },
                {"type", n => { Type = n.GetEnumValue<Attachment_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Attachment_associationType>("associationType", AssociationType);
            writer.WriteGuidValue("folderId", FolderId);
            writer.WriteStringValue("name", Name);
            writer.WriteBoolValue("replaceIfExists", ReplaceIfExists);
            writer.WriteEnumValue<Attachment_type>("type", Type);
