...
namespace Autodesk.ACC.CostManagement.Models {
    public class DistributionListResponse : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<Distribution>? Results { get; set; }
#nullable restore
#else
        public List<Distribution> Results { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="DistributionListResponse"/> and sets the default values.
        /// </summary>
        ...
        public static DistributionListResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"results", n => { Results = n.GetCollectionOfObjectValues<Distribution>(Distribution.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<Distribution>("results", Results);
