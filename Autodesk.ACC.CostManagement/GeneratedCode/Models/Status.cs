...
namespace Autodesk.ACC.CostManagement.Models {
    public class Status : IAdditionalDataHolder, IParsable 
    {
        ...
        public Status_associationType? AssociationType { get; set; }
...
#nullable restore
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"associationType", n => { AssociationType = n.GetEnumValue<Status_associationType>(); } },
                {"code", n => { Code = n.GetStringValue(); } },
                {"color", n => { Color = n.GetStringValue(); } },
                {"createdAt", n => { CreatedAt = n.GetDateTimeOffsetValue(); } },
                {"id", n => { Id = n.GetGuidValue(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"type", n => { Type = n.GetEnumValue<Status_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<Status_associationType>("associationType", AssociationType);
            writer.WriteStringValue("code", Code);
            writer.WriteStringValue("color", Color);
            writer.WriteStringValue("name", Name);
            writer.WriteEnumValue<Status_type>("type", Type);
