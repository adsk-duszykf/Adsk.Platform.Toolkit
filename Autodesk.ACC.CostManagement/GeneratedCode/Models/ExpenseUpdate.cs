...
namespace Autodesk.ACC.CostManagement.Models
{
    ...
    public partial class ExpenseUpdate : IAdditionalDataHolder, IParsable
    #pragma warning restore CS1591
    {
        ...
        public global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_aggregateBy? AggregateBy { get; set; }
        /// <summary>The date and time when the expense is approved.</summary>
        public DateTimeOffset? ApprovedAt { get; private set; }
        /// <summary>ID of the Budget Pay App to which the expense belongs.</summary>
...
#nullable restore
        ...
        public global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_integrationState? IntegrationState { get; set; }
...
#nullable restore
        ...
        public global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_scope? Scope { get; set; }
        /// <summary>The status of the expense. Possible values: ``draft``, ``pending``, ``revise``, ``rejected``, ``approved``, ``paid``.</summary>
        public global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "aggregateBy", n => { AggregateBy = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_aggregateBy>(); } },
                ...
                { "integrationState", n => { IntegrationState = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_integrationState>(); } },
                ...
                { "scope", n => { Scope = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_scope>(); } },
                { "status", n => { Status = n.GetEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_aggregateBy>("aggregateBy", AggregateBy);
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_integrationState>("integrationState", IntegrationState);
            ...
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_scope>("scope", Scope);
            writer.WriteEnumValue<global::Autodesk.ACC.CostManagement.Models.ExpenseUpdate_status>("status", Status);
