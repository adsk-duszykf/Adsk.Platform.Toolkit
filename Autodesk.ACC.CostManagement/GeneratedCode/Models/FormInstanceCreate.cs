...
namespace Autodesk.ACC.CostManagement.Models {
    public class FormInstanceCreate : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
        ...
        public FormInstanceCreate_integrationState? IntegrationState { get; set; }
...
#nullable restore
        ...
        public FormInstanceCreate_scope? Scope { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="FormInstanceCreate"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="FormInstanceCreate"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static FormInstanceCreate CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new FormInstanceCreate();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"integrationState", n => { IntegrationState = n.GetEnumValue<FormInstanceCreate_integrationState>(); } },
                {"name", n => { Name = n.GetStringValue(); } },
                {"note", n => { Note = n.GetStringValue(); } },
                {"scope", n => { Scope = n.GetEnumValue<FormInstanceCreate_scope>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<FormInstanceCreate_integrationState>("integrationState", IntegrationState);
            writer.WriteStringValue("name", Name);
            writer.WriteStringValue("note", Note);
            writer.WriteEnumValue<FormInstanceCreate_scope>("scope", Scope);
