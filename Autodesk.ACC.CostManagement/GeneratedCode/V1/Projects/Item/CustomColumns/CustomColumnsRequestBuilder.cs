...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.CustomColumns {
    ...
    /// </summary>
    public class CustomColumnsRequestBuilder : BaseRequestBuilder 
    {
        ...
        public CustomColumnsItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new CustomColumnsItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.CostManagement.v1.projects.item.customColumns.item collection</summary>
        /// <param name="position">The object ID of the item.</param>
        ...
        public CustomColumnsItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="CustomColumnsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;CustomColumn&gt;</returns>
...
#nullable enable
        public async Task<List<CustomColumn>?> GetAsync(Action<RequestConfiguration<CustomColumnsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<CustomColumn>> GetAsync(Action<RequestConfiguration<CustomColumnsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<CustomColumn>(requestInfo, CustomColumn.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CustomColumnsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<CustomColumnsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="CustomColumnsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public CustomColumnsRequestBuilder WithUrl(string rawUrl)
        {
            return new CustomColumnsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the ``Custom Column Setting`` in a specific project.
        /// </summary>
        public class CustomColumnsRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class CustomColumnsRequestBuilderGetRequestConfiguration : RequestConfiguration<CustomColumnsRequestBuilderGetQueryParameters> 
        {
        }
    }
}
