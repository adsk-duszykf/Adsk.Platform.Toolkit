...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.SavedViews {
    ...
    /// </summary>
    public class SavedViewsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="SavedViewsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<Filter>?> GetAsync(Action<RequestConfiguration<SavedViewsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<Filter>> GetAsync(Action<RequestConfiguration<SavedViewsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SavedViewsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SavedViewsRequestBuilderGetQueryParameters>> requestConfiguration = default)
...
#nullable restore
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/v1/projects/{projectId}/saved-views", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
        ...
        /// </summary>
        /// <returns>A <see cref="SavedViewsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public SavedViewsRequestBuilder WithUrl(string rawUrl)
        {
            return new SavedViewsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the saved view in a specific project.
        /// </summary>
        public class SavedViewsRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class SavedViewsRequestBuilderGetRequestConfiguration : RequestConfiguration<SavedViewsRequestBuilderGetQueryParameters> 
        {
        }
        /// <summary>
        /// Configuration for the request such as headers, query parameters, and middleware options.
        /// </summary>
        [Obsolete("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.")]
        public class SavedViewsRequestBuilderPostRequestConfiguration : RequestConfiguration<DefaultQueryParameters> 
        {
        }
    }
}
