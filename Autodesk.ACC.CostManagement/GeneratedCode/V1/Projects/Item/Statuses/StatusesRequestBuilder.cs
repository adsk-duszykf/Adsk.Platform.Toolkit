...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Statuses {
    ...
    public class StatusesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A List&lt;Autodesk.ACC.CostManagement.Models.Status&gt;</returns>
...
#nullable enable
        public async Task<List<Autodesk.ACC.CostManagement.Models.Status>?> GetAsync(Action<RequestConfiguration<StatusesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<Autodesk.ACC.CostManagement.Models.Status>> GetAsync(Action<RequestConfiguration<StatusesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Autodesk.ACC.CostManagement.Models.Status>(requestInfo, Autodesk.ACC.CostManagement.Models.Status.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
