...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Options.Item {
    ...
    /// </summary>
    public class WithTopicItemRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="WithTopicItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<Option>?> GetAsync(Action<RequestConfiguration<WithTopicItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<Option>> GetAsync(Action<RequestConfiguration<WithTopicItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<Option>(requestInfo, Option.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithTopicItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<WithTopicItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public WithTopicItemRequestBuilder WithUrl(string rawUrl)
        {
            return new WithTopicItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets options by topic and keywords
        /// </summary>
        public class WithTopicItemRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class WithTopicItemRequestBuilderGetRequestConfiguration : RequestConfiguration<WithTopicItemRequestBuilderGetQueryParameters> 
        {
        }
    }
}
