...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search
{
    ...
    public partial class ScheduleOfValuesSearchRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScheduleOfValuesSearchRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/projects/{projectId}/schedule-of-values/:search{?cursorState*,internalLimit*,limit*,sort*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public ScheduleOfValuesSearchRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/v1/projects/{projectId}/schedule-of-values/:search{?cursorState*,internalLimit*,limit*,sort*}", rawUrl)
        {
        }
        /// <summary>
...
#nullable enable
        public async Task<List<global::Autodesk.ACC.CostManagement.Models.SOV>?> PostAsync(global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchPostRequestBody body, Action<RequestConfiguration<global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder.ScheduleOfValuesSearchRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::Autodesk.ACC.CostManagement.Models.SOV>> PostAsync(global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchPostRequestBody body, Action<RequestConfiguration<global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder.ScheduleOfValuesSearchRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchPostRequestBody body, Action<RequestConfiguration<global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder.ScheduleOfValuesSearchRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchPostRequestBody body, Action<RequestConfiguration<global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder.ScheduleOfValuesSearchRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the SOVs in a specific project.
        /// </summary>
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ScheduleOfValuesSearchRequestBuilderPostQueryParameters 
        {
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ScheduleOfValuesSearchRequestBuilderPostRequestConfiguration : RequestConfiguration<global::Autodesk.ACC.CostManagement.V1.Projects.Item.ScheduleOfValues.Search.ScheduleOfValuesSearchRequestBuilder.ScheduleOfValuesSearchRequestBuilderPostQueryParameters>
        {
        }
    }
}
