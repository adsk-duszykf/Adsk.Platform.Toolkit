...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Terminologies {
    ...
    /// </summary>
    public class TerminologiesRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="TerminologiesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="TerminologyListResponse"/></returns>
...
#nullable enable
        public async Task<TerminologyListResponse?> GetAsync(Action<RequestConfiguration<TerminologiesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<TerminologyListResponse> GetAsync(Action<RequestConfiguration<TerminologiesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<TerminologyListResponse>(requestInfo, TerminologyListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns all the ``Terminologies`` in a specific project.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TerminologiesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<TerminologiesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="TerminologiesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public TerminologiesRequestBuilder WithUrl(string rawUrl)
        {
            return new TerminologiesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the ``Terminologies`` in a specific project.
        /// </summary>
        public class TerminologiesRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class TerminologiesRequestBuilderGetRequestConfiguration : RequestConfiguration<TerminologiesRequestBuilderGetQueryParameters> 
        {
        }
    }
}
