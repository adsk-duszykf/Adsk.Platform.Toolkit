...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Markups.Summary {
    ...
    public class SummaryRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A List&lt;MarkupSummary&gt;</returns>
...
#nullable enable
        public async Task<List<MarkupSummary>?> GetAsync(Action<RequestConfiguration<SummaryRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<MarkupSummary>> GetAsync(Action<RequestConfiguration<SummaryRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<MarkupSummary>(requestInfo, MarkupSummary.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
