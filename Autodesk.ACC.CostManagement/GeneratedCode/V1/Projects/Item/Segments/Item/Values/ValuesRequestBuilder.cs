...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Segments.Item.Values {
    ...
    public class ValuesRequestBuilder : BaseRequestBuilder 
    {
        ...
        public WithValueItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("valueId", position);
                return new WithValueItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.CostManagement.v1.projects.item.segments.item.values.item collection</summary>
        /// <param name="position">The segment value ID. To obtain a segment value ID, use `GET segments/:segmentId/values &lt;/en/docs/bim360/v1/reference/http/cost-values-GET/&gt;`_.</param>
        ...
        public WithValueItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
...
#nullable enable
        public async Task<SegmentValueListResponseWithOffset?> GetAsync(Action<RequestConfiguration<ValuesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<SegmentValueListResponseWithOffset> GetAsync(Action<RequestConfiguration<ValuesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<SegmentValueListResponseWithOffset>(requestInfo, SegmentValueListResponseWithOffset.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<SegmentValue?> PostAsync(SegmentValueCreate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<SegmentValue> PostAsync(SegmentValueCreate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(SegmentValueCreate body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(SegmentValueCreate body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#endif
            _ = body ?? throw new ArgumentNullException(nameof(body));
            var requestInfo = new RequestInformation(Method.POST, "{+baseurl}/v1/projects/{projectId}/segments/{segmentId}/values", PathParameters);
            requestInfo.Configure(requestConfiguration);
            requestInfo.Headers.TryAdd("Accept", "application/json");
