...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.DocumentPackages.Recent {
    ...
    /// </summary>
    public class DocumentPackagesRecentRequestBuilder : BaseRequestBuilder 
    {
        ...
        public RecentItemRequestBuilder this[Guid position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("id", position);
                return new RecentItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the Autodesk.ACC.CostManagement.v1.projects.item.documentPackages.Recent.item collection</summary>
        /// <param name="position">The object ID of the item.</param>
        ...
        public RecentItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="DocumentPackagesRecentRequestBuilder"/> and sets the default values.
        /// </summary>
