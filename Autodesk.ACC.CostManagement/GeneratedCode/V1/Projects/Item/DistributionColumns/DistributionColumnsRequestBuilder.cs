...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.DistributionColumns {
    ...
    /// </summary>
    public class DistributionColumnsRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="DistributionColumnsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="DistributionColumnListResponse"/></returns>
...
#nullable enable
        public async Task<DistributionColumnListResponse?> GetAsync(Action<RequestConfiguration<DistributionColumnsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<DistributionColumnListResponse> GetAsync(Action<RequestConfiguration<DistributionColumnsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<DistributionColumnListResponse>(requestInfo, DistributionColumnListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns all the distribution columns in a specific project.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DistributionColumnsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<DistributionColumnsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="DistributionColumnsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public DistributionColumnsRequestBuilder WithUrl(string rawUrl)
        {
            return new DistributionColumnsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the distribution columns in a specific project.
        /// </summary>
        public class DistributionColumnsRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class DistributionColumnsRequestBuilderGetRequestConfiguration : RequestConfiguration<DistributionColumnsRequestBuilderGetQueryParameters> 
        {
        }
    }
}
