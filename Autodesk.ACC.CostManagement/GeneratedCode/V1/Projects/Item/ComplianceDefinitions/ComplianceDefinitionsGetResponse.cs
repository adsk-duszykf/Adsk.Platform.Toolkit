...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.ComplianceDefinitions {
    public class ComplianceDefinitionsGetResponse : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<ComplianceDefinition>? Results { get; set; }
#nullable restore
#else
        public List<ComplianceDefinition> Results { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="ComplianceDefinitionsGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static ComplianceDefinitionsGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ComplianceDefinitionsGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"results", n => { Results = n.GetCollectionOfObjectValues<ComplianceDefinition>(ComplianceDefinition.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<ComplianceDefinition>("results", Results);
