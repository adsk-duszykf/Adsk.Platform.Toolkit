...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.ChangeOrders.Item.Item.CostItemsAssignLocations {
    public class CostItemsAssignLocationsPostRequestBody : IAdditionalDataHolder, IParsable 
    {
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="CostItemsAssignLocationsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="CostItemsAssignLocationsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static CostItemsAssignLocationsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new CostItemsAssignLocationsPostRequestBody();
        }
        /// <summary>
