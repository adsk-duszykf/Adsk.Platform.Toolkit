...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.ChangeOrders.Detach {
    public class ChangeOrdersDetach : IAdditionalDataHolder, IParsable 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="ChangeOrdersDetach"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="ChangeOrdersDetach"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static ChangeOrdersDetach CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new ChangeOrdersDetach();
        }
        /// <summary>
