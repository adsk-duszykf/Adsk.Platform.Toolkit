...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Contracts.Search {
    ...
    /// </summary>
    public class ContractsSearchRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="ContractsSearchRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ContractListResponse?> PostAsync(ContractsSearchPostRequestBody body, Action<RequestConfiguration<ContractsSearchRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ContractListResponse> PostAsync(ContractsSearchPostRequestBody body, Action<RequestConfiguration<ContractsSearchRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ContractsSearchPostRequestBody body, Action<RequestConfiguration<ContractsSearchRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ContractsSearchPostRequestBody body, Action<RequestConfiguration<ContractsSearchRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="ContractsSearchRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ContractsSearchRequestBuilder WithUrl(string rawUrl)
        {
            return new ContractsSearchRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the contracts in a specific project.
        /// </summary>
        public class ContractsSearchRequestBuilderPostQueryParameters 
        {
...
#nullable restore
        ...
        public class ContractsSearchRequestBuilderPostRequestConfiguration : RequestConfiguration<ContractsSearchRequestBuilderPostQueryParameters> 
        {
        }
    }
}
