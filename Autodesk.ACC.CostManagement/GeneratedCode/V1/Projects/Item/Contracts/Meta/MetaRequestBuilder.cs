...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Contracts.Meta {
    ...
    public class MetaRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="ContractListResponse"/></returns>
...
#nullable enable
        public async Task<ContractListResponse?> GetAsync(Action<RequestConfiguration<MetaRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ContractListResponse> GetAsync(Action<RequestConfiguration<MetaRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<ContractListResponse>(requestInfo, ContractListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns basic information of the contract in a specific project.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MetaRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<MetaRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// Returns basic information of the contract in a specific project.
        /// </summary>
        public class MetaRequestBuilderGetQueryParameters 
        {
...
#nullable restore
        ...
        public class MetaRequestBuilderGetRequestConfiguration : RequestConfiguration<MetaRequestBuilderGetQueryParameters> 
        {
        }
    }
}
