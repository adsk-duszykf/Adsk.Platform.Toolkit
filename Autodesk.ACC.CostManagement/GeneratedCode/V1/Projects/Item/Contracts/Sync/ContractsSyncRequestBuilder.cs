...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Contracts.Sync {
    ...
    /// </summary>
    public class ContractsSyncRequestBuilder : BaseRequestBuilder 
    {
        /// <summary>
        /// Instantiates a new <see cref="ContractsSyncRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<ContractSync?> PostAsync(ContractsSyncPostRequestBody body, Action<RequestConfiguration<ContractsSyncRequestBuilderPostQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<ContractSync> PostAsync(ContractsSyncPostRequestBody body, Action<RequestConfiguration<ContractsSyncRequestBuilderPostQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<ContractSync>(requestInfo, ContractSync.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Returns all the contracts in a specific project.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(ContractsSyncPostRequestBody body, Action<RequestConfiguration<ContractsSyncRequestBuilderPostQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(ContractsSyncPostRequestBody body, Action<RequestConfiguration<ContractsSyncRequestBuilderPostQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="ContractsSyncRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public ContractsSyncRequestBuilder WithUrl(string rawUrl)
        {
            return new ContractsSyncRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns all the contracts in a specific project.
        /// </summary>
        public class ContractsSyncRequestBuilderPostQueryParameters 
        {
        ...
        public class ContractsSyncRequestBuilderPostRequestConfiguration : RequestConfiguration<ContractsSyncRequestBuilderPostQueryParameters> 
        {
        }
    }
}
