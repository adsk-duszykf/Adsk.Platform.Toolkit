...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.DefaultValues {
    public class DefaultValuesGetResponse : IAdditionalDataHolder, IParsable 
    {
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<DefaultValue>? Results { get; set; }
#nullable restore
#else
        public List<DefaultValue> Results { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="DefaultValuesGetResponse"/> and sets the default values.
        /// </summary>
        ...
        public static DefaultValuesGetResponse CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new DefaultValuesGetResponse();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"results", n => { Results = n.GetCollectionOfObjectValues<DefaultValue>(DefaultValue.CreateFromDiscriminatorValue)?.ToList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<DefaultValue>("results", Results);
