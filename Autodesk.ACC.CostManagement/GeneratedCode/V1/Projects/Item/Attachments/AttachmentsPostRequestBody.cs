...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Attachments {
    public class AttachmentsPostRequestBody : IAdditionalDataHolder, IParsable 
    {
        ...
        public AttachmentsPostRequestBody_associationType? AssociationType { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="AttachmentsPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="AttachmentsPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static AttachmentsPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                {"associationType", n => { AssociationType = n.GetEnumValue<AttachmentsPostRequestBody_associationType>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<AttachmentsPostRequestBody_associationType>("associationType", AssociationType);
