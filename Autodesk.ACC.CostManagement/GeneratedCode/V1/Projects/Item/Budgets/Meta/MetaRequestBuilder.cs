...
namespace Autodesk.ACC.CostManagement.V1.Projects.Item.Budgets.Meta {
    ...
    public class MetaRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// </summary>
        /// <returns>A <see cref="SimpleBudgetListResponse"/></returns>
...
#nullable enable
        public async Task<SimpleBudgetListResponse?> GetAsync(Action<RequestConfiguration<MetaRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<SimpleBudgetListResponse> GetAsync(Action<RequestConfiguration<MetaRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<SimpleBudgetListResponse>(requestInfo, SimpleBudgetListResponse.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets basic information of budget in budget container
        /// </summary>
